...
def seed_db(session: Session) -> None:
    ...
    groups = [
        Group(id="calisthenics-study", name="Calisthenics & Focus", field="Wellness/Productivity", exam=None, description="Daily calisthenics + deep work accountability"),
        Group(id="algorithms-101", name="Algorithms 101", field="Computer Science", exam="Intro Algorithms Midterm", description="Greedy, DP, graphs – weekly problem sets"),
        Group(id="ielts-prep", name="IELTS Prep Sprint", field="Languages", exam="IELTS", description="Speaking drills, writing feedback, mock tests"),
    ]
    for g in groups:
        session.add(g)
    session.commit()
