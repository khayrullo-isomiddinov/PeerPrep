                ...
                <div className="hidden md:flex items-center gap-2">
                  <div className="rounded-full ring-1 ring-white/10 bg-white/5 px-3 py-1.5">
                    <input
                      type="text"
                      placeholder="Search…"
                      className="bg-transparent outline-none w-48 md:w-60 text-sm placeholder:text-white/50"
                    />
                  </div>
                </div>

                <Link to="/register" className="rounded-full px-4 py-1.5 text-sm font-semibold text-black bg-[rgb(129,236,178)] hover:opacity-90 transition">
                  Sign Up
                </Link>
                <Link to="/login" className="rounded-full px-4 py-1.5 text-sm font-semibold ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition">
                  Login
                </Link>

                <Link to="/profile" className="hidden sm:inline-block">
                  <img
                    src="https://ui-avatars.com/api/?name=U&background=10b981&color=fff"
                    alt="Profile"
